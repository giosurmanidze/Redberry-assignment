      ...
      <div className="header">
        <div className="header__infos">
          <div>
            ...
            <p className="email__detail">{data?.email && <img  src={EMAIL_ICON}/>}{data?.email}</p>
            <p className="phone__detail">{data?.phone_number && <img  src={PHONE_ICON}/>}{data?.phone_number}</p>
          </div>
